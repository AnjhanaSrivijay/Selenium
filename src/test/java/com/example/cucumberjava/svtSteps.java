...
public class svtSteps {
    ...
    public void user_accepts_the_cookies() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@data-rt='cookie-consent-modal']")));
    }
